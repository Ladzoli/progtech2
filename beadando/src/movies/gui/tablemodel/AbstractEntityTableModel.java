...
public abstract class AbstractEntityTableModel <E extends EntityWithId> extends AbstractTableModel{
    ...
    public AbstractEntityTableModel(String[] columnNames, EntityController<E> controller) {
    ...
    public abstract void addNewEntity(String[] tomb);
}
